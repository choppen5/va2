...
insert sft_mng_sys(sft_mng_sys_id,name,type) values (1,'Virtual Administrator 2','VA2')
go
...
insert sft_error_defs (error_defs_id,name,search_string,ev_level,ev_type,ev_sub_type) values (3,'Process or Component exited with Error','Process exited with error','','Process exited with error','')
go
