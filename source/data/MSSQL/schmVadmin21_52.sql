...
*/
if db_name() = 'vadmin21_52'
    raiserror('''vadmin21_52'' database created, and context now in use.',1,1)
else
    raiserror('error in batch file, ''use vadmin21_52'' failed!  killing the spid now.',22,127) with log
 
go
 
execute sp_dboption 'vadmin21_52' ,'trunc. log on chkpt.' ,'true'
