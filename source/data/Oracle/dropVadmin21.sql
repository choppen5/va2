...
rem
rem Drop Table          : analysis_errdef
rem
DROP TABLE analysis_errdef;
 
 
rem
rem Drop Table          : notification_reaction
rem
DROP TABLE notification_reaction;
...
rem
rem Drop Table          : folders
rem
DROP TABLE folders;
 
 
rem
rem Drop Table          : sessions
rem
DROP TABLE sessions;
 
 
rem
rem Drop Table          : resonate_ar
rem
DROP TABLE resonate_ar;
 
 
rem
rem Drop Table          : data_source
rem
DROP TABLE data_source;
 
 
rem
rem Drop Table          : tableids
rem
DROP TABLE tableids;
