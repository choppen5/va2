...
if ($columncount > 15) {
	$siebversion = 8;
	$sqlinsert = "insert into monitored_comps (monitored_comps_id,sft_elmnt_id,sv_name,cc_alias,cc_name,ct_alias,cg_name,cc_runmode,cp_disp_run_state,cp_num_run,cp_max_tas,cp_actv_mt,cp_max_mts,cp_start_time,cp_end_time,cp_status) values ($incvar,$server_id,\'$fl[0]\',\'$fl[1]\' , \'$fl[2]\', \'$fl[3]\', \'$fl[4]\',\'$fl[5]\', \'$fl[6]\',\'$fl[8]\',\'$fl[9]\',\'$fl[10]\', \'$fl[11]\', \'$fl[12]\',\'$fl[13]\',\'$fl[14]\')";
	$sqlupdate = "update monitored_comps set cc_alias = \'$fl[1]\' ,cc_name = \'$fl[2]\',ct_alias = \'$fl[3]\',cg_name= \'$fl[4]\',cc_runmode = \'$fl[5]\',cp_disp_run_state = \'$fl[6]\',cp_num_run = \'$fl[8]\',cp_max_tas = \'$fl[9]\',cp_actv_mt = \'$fl[10]\',cp_max_mts = \'$fl[11]\',cp_start_time = \'$fl[12]\',cp_end_time = \'$fl[13]\',cp_status = \'$fl[14]\' where cc_alias = \'$fl[1]\' and sft_elmnt_id = $server_id" ;
} else {
